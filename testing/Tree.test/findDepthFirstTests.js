...
const findDepthFirstTests = ({ unitTesting, filesystem, findTypeMethod, logFind}) => {
    unitTesting.addAssertion([
        `findDepthFirst filesystem.find '/music'`,
    ...
    unitTesting.addAssertion([
        `findDepthFirst filesystem.find '/cod.exe'`,
    ...
    unitTesting.addAssertion([
        `findDepthFirst filesystem.find '/tax.docx'`,
    ...
    unitTesting.addAssertion([
        `findDepthFirst filesystem.find '/personal'`,
    ...
    unitTesting.addAssertion([
        `findDepthFirst filesystem.find '/counter-strike.exe'`,
    ...
    unitTesting.addAssertion([
        `findDepthFirst filesystem.find '/unexistend_folder'`,
...
export default findDepthFirstTests
